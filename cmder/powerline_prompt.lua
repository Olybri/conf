...
function colorful_git_prompt_filter()
    ...
    local colors = {
        -- clean = "\x1b[0m\x1b[34;40m\x1b[37;44m",
        -- dirty = "\x1b[0m\x1b[31;40m\x1b[39;41m",
        clean = "\x1b[0m\x1b[38;5;8m\x1b[44m\x1b[37;44m",
        dirty = "\x1b[0m\x1b[38;5;8m\x1b[41m\x1b[39;41m",
    }
    ...
    clink.prompt.value = string.gsub(clink.prompt.value, "{git}", "\x1b[38;5;8m\x1b[40m")
    return false
end
